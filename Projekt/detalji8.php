        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/serija 8 detalji 1.jpg" alt="" style="width: 1366px; height: 768px;">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/serija 8 detalji 2.jpg" alt="" style="width: 1366px; height: 768px;">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/serija 8 detalji 3.jpg" alt="" style="width: 1366px; height: 768px;">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>Traktor</h3>
              <ul>
                <li>443 KS (326 kW) Maks. snaga (ECE-R 120) + 15 KS (11 kW) IPM</li>
                <li>9,0 l motor s 6 cilindra</li>
                <li>13,8 t i međuosovinsko rastojanje 3.050 m</li>
                <li>Nova veća i udobnija CommandView kabina s novom razinom vidljivosti</a></li>
              </ul>
            </div>
