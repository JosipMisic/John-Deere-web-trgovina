        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/serija 7 detalji 1.jpg" alt="" style="width: 1366px; height: 768px;">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/serija 7 detalji 2.jpg" alt="" style="width: 1366px; height: 768px;">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/serija 7 detalji 3.jpg" alt="" style="width: 1366px; height: 768px;">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>Traktor</h3>
              <ul>
                <li>385 KS (283 kW) Maks. snaga (ECE-R 120) + 3 KS (2 kW) IPM</li>
                <li>9,0 l motor s 6 cilindra</li>
                <li>11,4 t i međuosovinsko rastojanje 2.925 m</li>
                <li>XXL Comfort kabina sa sjedištem Active Seat II, radiom sa zaslonom osjetljivim na dodir i novom upravljačkom palicom CommandPRO</li>
                <li>Precizna poljoprivredna rješenja</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Sklopite svoju konfiguraciju</h2>
              <a class="btn btn-warning" href="" role="button">Naruči</a>
            </div>
          </div>
